...
// ValidateCheckInUseCase: name the main entity or variable we are testing as sut (Sistem under Test) - Desing pattern
...
describe('Validate Check-in Use Case', () => {
  ...
  it('shold be not able to validate the check-in after 20 minutes of its creation', async () => {
